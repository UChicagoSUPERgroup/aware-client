            ...
            if (convertView == null) {
                try {
                    ...
                    if (pkg.versionName.equals("bundled")) {
                       if (cards.getJSONObject(position).getString(Aware_Plugins.PLUGIN_PACKAGE_NAME).equals("com.aware.plugin.google.activity_recognition")) {
                            convertView = new com.aware.plugin.google.activity_recognition.ContextCard().getContextCard(mContext);
                        }
                       else if (cards.getJSONObject(position).getString(Aware_Plugins.PLUGIN_PACKAGE_NAME).equals("com.aware.plugin.superstudy")) {
                            convertView = new com.aware.plugin.superstudy.ContextCard().getContextCard(mContext);
                        }
                    } else {
